 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_si')){
	function azrcrv_create_plugin_menu_si(){
		azrcrv_create_plugin_menu_table_si();
		azrcrv_populate_plugin_menu_table_si();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_si')){
	function azrcrv_populate_plugin_menu_table_si(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_si')){
	function azrcrv_create_plugin_menu_table_si(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
